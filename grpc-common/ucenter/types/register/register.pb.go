...
func (x *ReqRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReqRes) ProtoMessage() {}

func (x *ReqRes) ProtoReflect() protoreflect.Message {
	mi := &file_register_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReqRes.ProtoReflect.Descriptor instead.
func (*ReqRes) Descriptor() ([]byte, []int) {
...
var file_register_proto_rawDesc = []byte{
	...
	0x08, 0x0a, 0x06, 0x52, 0x65, 0x71, 0x52, 0x65, 0x73, 0x22, 0x07, 0x0a, 0x05, 0x4e, 0x6f, 0x52,
	...
	0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x71, 0x52, 0x65, 0x73,
...
var file_register_proto_depIdxs = []int32{
	...
	2, // 3: register.Register.registerByPhone:output_type -> register.ReqRes
