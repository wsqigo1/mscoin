...
type RegisterClient interface {
	RegisterByPhone(ctx context.Context, in *RegReq, opts ...grpc.CallOption) (*ReqRes, error)
...
func (c *registerClient) RegisterByPhone(ctx context.Context, in *RegReq, opts ...grpc.CallOption) (*ReqRes, error) {
...
type RegisterServer interface {
	RegisterByPhone(context.Context, *RegReq) (*ReqRes, error)
...
func (UnimplementedRegisterServer) RegisterByPhone(context.Context, *RegReq) (*ReqRes, error) {
